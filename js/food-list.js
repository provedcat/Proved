(function () {
  ...
  const TAG_CATEGORY_TAB_LABELS = { protein_source: '단백질', life_stage: '생애', management_purpose: '기능', processing_method: '제조', ingredient_condition: '원재료', preparation_type: '제조' };
